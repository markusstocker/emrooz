...
public class DimensionPropertyTest {

	@Test
	@FileParameters("src/test/resources/DimensionPropertyTest.csv")
	public void testDimensionProperty(
			...
			String assertType) {
		if (type1 == null)
			type1 = QB.DimensionProperty;
		if (type2 == null)
			type2 = QB.DimensionProperty;

		DimensionProperty p1 = new DimensionProperty(id1, type1);
		DimensionProperty p2 = new DimensionProperty(id2, type2);
		
		Set<URI> types1 = new HashSet<URI>();
		types1.add(type1);
		types1.add(QB.DimensionProperty);
		types1.add(QB.ComponentProperty);
		
		Set<URI> types2 = new HashSet<URI>();
		types2.add(type2);
		types2.add(QB.DimensionProperty);
